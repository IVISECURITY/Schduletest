...
while True:
    ...
    if media_files:
        print("media file #",media_files[media_index],datetime.now())
        videopath = media_files[media_index]
        subprocess.Popen(['omxplayer',videopath],stdin=subprocess.PIPE,stdout=subprocess.PIPE,stderr=subprocess.PIPE, close_fds=False)
        ...
        for key,value in d.items():
            ...
            print("newkey", newkey)
            print("medipath", media_files[media_index])
        ...
        subprocess.Popen(['omxplayer','/home/pi/Downloads/Schduletest/media'],stdin=subprocess.PIPE,stdout=subprocess.PIPE,stderr=subprocess.PIPE, close_fds=False)
